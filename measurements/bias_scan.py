...
class BiasScanConfigureDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        for i in range(3):
            ...
            spinbox.setValue(BiasScanConfigureDialog.cached_settings['vrange'][i])
        ...
        self.filename = QLineEdit(BiasScanConfigureDialog.cached_settings['path'])
        ...
        for i in range(3):
            ...
            if i + 1 in BiasScanConfigureDialog.cached_settings['channels']:
    ...
    def __del__(self):
        BiasScanConfigureDialog.cached_settings = self.extract_settings()
    ...
    def finalize(self):
        ...
        BiasScanConfigureDialog.cached_settings = self.ret
        self.accept()
